// Based on https://github.com/DCRichards/arduino-vagrant-rust/blob/7bdd4a5eb15639a78cf7826a95863e21a98eb0bb/apps/plant/app/src/usb_logger.rs
use {
    arduino_nano33iot as bsp,
...
macro_rules! from {
    ($stone:expr) => {
        base::components::usb_logger::USBLogger::new(
            $stone.usb,
            &mut $stone.clock,
            &mut $stone.pm,
            $stone.pins.usb_dm.into(),
            $stone.pins.usb_dp.into(),
            &mut $stone.nvic,
        )
    };
}
